            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button onClick={() => navigate('/admin/books')} className="p-4 bg-indigo-50 rounded-lg text-indigo-700 font-medium hover:bg-indigo-100 transition text-left">
                            + Add New Book
                        </button>
                        <button onClick={() => navigate('/admin/members')} className="p-4 bg-emerald-50 rounded-lg text-emerald-700 font-medium hover:bg-emerald-100 transition text-left">
                            + Register Member
                        </button>
                        <button onClick={() => navigate('/admin/issue-return')} className="p-4 bg-orange-50 rounded-lg text-orange-700 font-medium hover:bg-orange-100 transition text-left">
                            Issue Book
                        </button>
                        <button onClick={() => navigate('/admin/issue-return')} className="p-4 bg-purple-50 rounded-lg text-purple-700 font-medium hover:bg-purple-100 transition text-left">
                            Return Book
                        </button>
                    </div>
                </div>
